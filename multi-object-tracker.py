...
yolomodel = {"config_path": "E:\datasets\yolov3\yolov3.cfg",
             "model_weights_path": "E:\datasets\yolov3\yolov3.weights",
             "coco_names": "E:\datasets\yolov3\coco.names",
...
video_src = "E:/Skopus/recordings/input/600.mp4"
...
while (True):
    ...
    cv.putText(image, "Peds: " + str(pedestrian_tracker.number_of_elements + 1), (30, 60),
               cv.FONT_HERSHEY_SIMPLEX, 2, pedestrian_clr, 5)
    cv.putText(image, "Cars: " + str(car_tracker.number_of_elements + 1), (30, 130),
               cv.FONT_HERSHEY_SIMPLEX, 2, car_clr, 5)
    ...
    if writer is None:
        ...
        writer = cv.VideoWriter("E:/Skopus/recordings/output/output_NMS_yolov3_car_peds.avi", fourcc, 20, (W, H), True)
    writer.write(image)
writer.release()
cap.release()
